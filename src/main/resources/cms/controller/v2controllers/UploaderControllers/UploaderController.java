...
import main.resources.cms.view.pages.CsvUploader;
import main.resources.cms.view.pages.MainUploader;
...
public class UploaderController {
    ...
    public void initialize() {
        rootPane.getStylesheets().add(this.getClass().getResource(
                "/main/resources/cms/view/pages/stylesheets/ImagesCSS.css").toExternalForm());
        ...
        rootPane.getChildren().addAll(mainUploaderButton, csvUploaderButton);
    }
